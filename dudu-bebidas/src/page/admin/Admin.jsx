    ...
    <div className="adm-root">
      <div className="adm-wrap">
        ...
        <div className="adm-tabs">
          <button
            className={`adm-tab ${activeTab === "pedidos" ? "adm-tab-active" : ""}`}
            onClick={() => setActiveTab("pedidos")}
          >
            📦 Pedidos{" "}
            {totalCount > 0 && (
              <span className="adm-tab-badge">{totalCount}</span>
            )}
          </button>
          <button
            className={`adm-tab ${activeTab === "produtos" ? "adm-tab-active" : ""}`}
            onClick={() => setActiveTab("produtos")}
          >
            🍺 Produtos{" "}
            {products.length > 0 && (
              <span className="adm-tab-badge">{products.length}</span>
            )}
          </button>
        </div>
